    ...
    <OGDialog open={isOpen} onOpenChange={handleOpenChange}>
      <OGDialogPortal>
        ...
        >
          ...
          <div className="sharepoint-picker-bg relative flex p-2">
            <div ref={containerCallbackRef} className="sharepoint-picker-bg flex-1 rounded-lg" />
            {/* SharePoint iframe will be injected into the div above by the hook */}
