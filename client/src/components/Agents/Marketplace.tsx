...
import { TooltipAnchor, Button, NewChatIcon, useMediaQuery } from '@aipyq/client';
import { PermissionTypes, Permissions, QueryKeys } from '@aipyq/data-provider';
...
const AgentMarketplace: React.FC<AgentMarketplaceProps> = ({ className = '' }) => {
  ...
  // Set page title
  useDocumentTitle(`${localize('com_agents_marketplace')} | Aipyq`);
