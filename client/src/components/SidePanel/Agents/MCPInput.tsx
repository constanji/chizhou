      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="border-token-border-medium flex h-9 w-full rounded-lg border bg-transparent px-3 py-1.5 text-sm text-text-primary dark:text-text-primary outline-none placeholder:text-text-secondary-alt focus:ring-1 focus:ring-border-light"
      ...
      {showTools && mcp?.metadata.tools && (
        <div className="mt-4 flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <h3 className="text-token-text-primary dark:text-text-primary block font-medium">
              ...
              >
                <Checkbox
                  ...
                  aria-label={tool
                    ...
                    .join(' ')}
                />
                <span className="text-token-text-primary dark:text-text-primary">
                  {tool
                    .split('_')
                    .map((word) => word.charAt(0).toUpperCase() + word.slice(1))
                    .join(' ')}
