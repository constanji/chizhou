    ...
    <OGDialog>
      ...
      >
        ...
        <div className="flex grow cursor-not-allowed items-center gap-1 rounded bg-transparent p-0 text-left transition-colors">
          <div
            className="grow select-none px-2 py-1.5 text-text-primary dark:text-text-primary"
        ...
        <OGDialogTrigger asChild>
          <button
            type="button"
            className="flex h-7 w-7 items-center justify-center rounded transition-all duration-200 hover:bg-surface-active-alt focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1"
