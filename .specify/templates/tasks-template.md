...
**测试**：下面的示例包括测试任务。测试是可选的 - 仅在功能规范中明确请求时才包含它们。
...
- [ ] T010 [P] [US1] 在 tests/contract/test_[name].py 中为 [端点] 创建合约测试
- [ ] T011 [P] [US1] 在 tests/integration/test_[name].py 中为 [用户旅程] 创建集成测试
...
- [ ] T018 [P] [US2] 在 tests/contract/test_[name].py 中为 [端点] 创建合约测试
- [ ] T019 [P] [US2] 在 tests/integration/test_[name].py 中为 [用户旅程] 创建集成测试
...
- [ ] T024 [P] [US3] 在 tests/contract/test_[name].py 中为 [端点] 创建合约测试
- [ ] T025 [P] [US3] 在 tests/integration/test_[name].py 中为 [用户旅程] 创建集成测试
...
- [ ] TXXX 代码清理和重构
- [ ] TXXX 跨所有故事的性能优化
- [ ] TXXX [P] 在 tests/unit/ 中的其他单元测试（如请求）
- [ ] TXXX 安全加固
...
任务："在 tests/contract/test_[name].py 中为 [端点] 创建合约测试"
任务："在 tests/integration/test_[name].py 中为 [用户旅程] 创建集成测试"
