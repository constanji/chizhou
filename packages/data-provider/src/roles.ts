  ...
  [SystemRoles.ADMIN]: roleSchema.extend({
    ...
    permissions: permissionsSchema.extend({
      ...
      [PermissionTypes.BOOKMARKS]: bookmarkPermissionsSchema.extend({
        [Permissions.USE]: z.boolean().default(false), // 禁用书签功能
      }),
      ...
      [PermissionTypes.MULTI_CONVO]: multiConvoPermissionsSchema.extend({
        [Permissions.USE]: z.boolean().default(false), // 禁用多轮对话功能
      }),
      [PermissionTypes.TEMPORARY_CHAT]: temporaryChatPermissionsSchema.extend({
        [Permissions.USE]: z.boolean().default(false), // 禁用临时对话功能
      }),
  ...
  [SystemRoles.ADMIN]: {
    ...
    permissions: {
      ...
      [PermissionTypes.MULTI_CONVO]: {
        [Permissions.USE]: false, // 禁用多轮对话功能
      },
      [PermissionTypes.TEMPORARY_CHAT]: {
        [Permissions.USE]: false, // 禁用临时对话功能
      },
