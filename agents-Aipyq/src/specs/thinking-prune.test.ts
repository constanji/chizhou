    ...
    const assistantMessageWithThinking = new AIMessage({
      content: [
        ...
        },
        {
          ...
          input: '{"command": "view", "path": "/home/danny/Aipyq/gistfile1.txt", "description": "Viewing lines 1-200 of the file", "view_range": [1,200]}',
        },
      ],
    });
    ...
    const assistantMessage2 = new AIMessage({
      content: [
        ...
        },
        {
          ...
          name: 'text_editor_mcp_textEditor',
          input: '{"command": "view", "path": "/home/danny/Aipyq/gistfile1.txt", "description": "Viewing lines 201-400 of the file", "view_range": [201,400]}',
        },
      ],
    });
    ...
    const assistantMessage3 = new AIMessage({
      content: [
        ...
        },
        {
          ...
          name: 'text_editor_mcp_textEditor',
          input: '{"command": "view", "path": "/home/danny/Aipyq/gistfile1.txt", "description": "Viewing lines 401-600 of the file", "view_range": [401,600]}',
        },
      ],
    });
    ...
    const assistantMessage4 = new AIMessage({
      content: [
        ...
        },
        {
          ...
          name: 'text_editor_mcp_textEditor',
          input: '{"command": "view", "path": "/home/danny/Aipyq/gistfile1.txt", "description": "Viewing lines 601-800 of the file", "view_range": [601,800]}',
        },
      ],
    });
