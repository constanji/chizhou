...
export class AzureChatOpenAI extends OriginalAzureChatOpenAI {
  ...
  static lc_name(): 'AipyqAzureOpenAI' {
    return 'AipyqAzureOpenAI';
  }
  /**
   * Returns backwards compatible reasoning parameters from constructor params and call options
   * @internal
      ...
      params.defaultHeaders = {
        ...
        'User-Agent':
          defaultHeaders['User-Agent'] != null
            ? `${defaultHeaders['User-Agent']}: aipyq-azure-openai-v2`
            : 'aipyq-azure-openai-v2',
      };
...
export class ChatDeepSeek extends OriginalChatDeepSeek {
  ...
  static lc_name(): 'AipyqDeepSeek' {
    return 'AipyqDeepSeek';
  }
  protected _getClientOptions(
    options?: OpenAICoreRequestOptions
  ): OpenAICoreRequestOptions {
